...
const PLANS = [
    {
        id: 'plan-a',
        name: '第一阶段：三大核心功能 + 基础能力底座',
        tag: '推荐',
        summary: '微软技术赋能永旺——聚焦 3 个核心业务功能，配套基础能力底座，双方协同开发快速验证价值。',
    ...
    {
        id: 'plan-b',
        name: '第二阶段：全量功能覆盖 + 分版本交付',
        tag: null,
        summary: '永旺 DMC 为主，微软提供技术咨询——在第一阶段基础上扩展，覆盖剩余功能点，按 V1.0 / V2.0 / V2.1 三期交付。',
        strategy: '阶段一完成核心验证后，三期增量交付：V1.0 营销内容+效率统计（3个功能），V2.0 自动化+个性化（3个功能），V2.1 深度AI（4个功能）。',
        // 按期分组的功能点
        phaseFeatures: [
            {
                phase: 'V1.0',
                title: '第一期：营销内容 + 效率统计',
                focus: '营销文案生成 + 策略推荐 + 效率看板',
                features: [
        ...
        baseInfra: null,
        phases: [
            { name: 'V1.0', items: ['AI 生成营销文案', '通用营销方案策划', 'AI 效率统计'], focus: '营销内容 + 效率看板', acceptance: '文案生成 + 策略推荐 + 统计上线' },
            { name: 'V2.0', items: ['自动创建画布', '营销建议', '后台升级'], focus: '自动化 + 个性化', acceptance: '画布自动化 + 个性化建议' },
            { name: 'V2.1', items: ['数据复盘 Agent', '图片生成', '营销专家库', '框架升级'], focus: '深度 AI', acceptance: '全 Agent 上线' },
        ],
        pros: ['聚焦增量：只做阶段一未覆盖的功能', '分期交付：节奏清晰', '对齐客户原始路线图'],
        cons: ['依赖阶段一交付质量', '营销画布 API 开放度是最大风险', '专家库需大量历史数据'],
        ganttTasks: [
            // V1.0
            { section: 'V1.0', name: 'AI 营销文案', start: '2026-08-01', days: 14 },
            { section: 'V1.0', name: '营销方案策划', start: '2026-08-08', days: 14 },
